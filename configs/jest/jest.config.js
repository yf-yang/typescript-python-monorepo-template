...
const config = {
  ...
  // Automatically clear mock calls, instances, contexts and results before every
  ...
  // module's location moduleDirectories: [ "node_modules" ],
  ...
  // matched tests are skipped testPathIgnorePatterns: [ "/node_modules/" ],
  ...
  transform: {
    // @ts-expect-error -- swc config is valid
